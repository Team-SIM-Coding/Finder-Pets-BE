...
public class LostPetsThumbnailResponse {
    ...
    @QueryProjection
    public LostPetsThumbnailResponse(Long id, Category category, IsCompleted isCompleted, Breed breed, BreedGroup breedGroup, Gender gender, float weight,
                                     String specialMark, String happenPlace, String thumbnailImgPath, Integer views, Integer totalLike) {
        this.id = id;
