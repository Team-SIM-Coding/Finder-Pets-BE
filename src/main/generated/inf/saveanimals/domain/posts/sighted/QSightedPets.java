...
public class QSightedPets extends EntityPathBase<SightedPets> {
    ...
    public final StringPath authorImg = createString("authorImg");

    public final StringPath authorNick = createString("authorNick");
    ...
    public final ListPath<SightedComments, SimplePath<SightedComments>> comments = this.<SightedComments, SimplePath<SightedComments>>createList("comments", SightedComments.class, SimplePath.class, PathInits.DIRECT2);
